...
#' "... nearly fixed markers (e.g., π < 0.05 or π > 0.95) are not expected to
#' be associated with any covariate, even if they are adjacent to strongly
...
pooldata2genobaypass(pool_dat, "~/_data/_baypass", "THINNED__tany_time",
                     subsamplesize = pool_dat@nsnp %/% 3L)
